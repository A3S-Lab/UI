...
| `src/ActionIcon/index.mdx`                                         | Compose          | Button with icon-only size and accessible name                                  | Verified — composition: `components/button.mdx`                 |
| `src/ActionIconGroup/index.mdx`                                    | Compose          | Button Group of icon-only Buttons                                               | Verified — composition: `components/button-group.mdx`           |
...
| `src/Block/index.mdx`                                              | Compose          | Card or Item surface                                                            | Verified — composition: `components/card.mdx`, `components/item.mdx` |
| `src/Burger/index.mdx`                                             | Compose          | App Shell or Sidebar trigger using Button                                       | Verified — composition: `components/app-shell.mdx`, `components/sidebar.mdx` |
...
| `src/DownloadButton/index.mdx`                                     | Compose          | Button plus a host-owned download action                                        | Verified — composition: `components/button.mdx`                 |
| `src/DraggablePanel/index.mdx`                                     | Adapt            | Split Pane and resizable Task Pane                                              | Verified — component: `split-pane`, `task-pane`                |
| `src/DraggableSideNav/index.mdx`                                   | Compose          | Sidebar inside Split Pane                                                       | Verified — composition: `components/sidebar.mdx`, `components/split-pane.mdx` |
...
| `src/EditorSlashMenu/index.mdx`                                    | Compose          | Command anchored to an editor caret                                             | Verified — composition: `components/command.mdx`                |
...
| `src/Flex/index.mdx`                                               | Foundation       | Flex layout utilities                                                           | Verified — foundation: `foundations/spacing.mdx`                |
| `src/FluentEmoji/index.mdx`                                        | Host integration | Avatar or Icon with host-provided emoji assets                                  | Verified — integration: `components/icon.mdx`, `components/avatar.mdx` |
...
| `src/Footer/index.mdx`                                             | Compose          | App Page footer and Status Bar                                                  | Verified — composition: `components/app-page.mdx`, `components/status-bar.mdx` |
| `src/Form/index.mdx`                                               | Direct           | Form, Field, and submit state                                                   | Verified — component: `form`, `field`                          |
| `src/FormModal/index.mdx`                                          | Compose          | Dialog containing Form                                                          | Verified — composition: `components/dialog.mdx`, `components/form.mdx` |
| `src/Freeze/index.mdx`                                             | Compose          | Bounded busy surface using Progress or Skeleton                                 | Verified — composition: `components/progress.mdx`, `components/skeleton.mdx` |
| `src/Grid/index.mdx`                                               | Foundation       | Grid layout utilities                                                           | Verified — foundation: `foundations/spacing.mdx`                |
| `src/GroupAvatar/index.mdx`                                        | Compose          | Avatar Group                                                                    | Verified — composition: `components/avatar.mdx`                 |
...
| `src/MaskShadow/index.mdx`                                         | Compose          | Scroll Area edge shadows                                                        | Verified — composition: `components/scroll-area.mdx`            |
| `src/MaterialFileTypeIcon/index.mdx`                               | Host integration | File Type Icon with host icon registry                                          | Verified — integration: `components/file-type-icon.mdx`         |
| `src/Menu/index.mdx`                                               | Compose          | Dropdown Menu, Context Menu, or Command by task                                 | Verified — composition: `components/dropdown-menu.mdx`, `components/context-menu.mdx`, `components/command.mdx` |
| `src/Mermaid/index.mdx`                                            | Host integration | Markdown diagram renderer inside a Markdown Surface                             | Verified — integration: `components/markdown-surface.mdx`       |
...
| `src/NeuralNetworkLoading/index.mdx`                               | Compose          | Spinner, Skeleton, Progress, or Brand Loading by information need               | Verified — composition: `components/spinner.mdx`, `components/skeleton.mdx`, `components/progress.mdx`, `components/brand-lockup.mdx` |
| `src/ScrollArea/index.mdx`                                         | Direct           | Scroll Area                                                                     | Verified — component: `scroll-area`                            |
| `src/ScrollShadow/index.mdx`                                       | Compose          | Scroll Area with edge shadows                                                   | Verified — composition: `components/scroll-area.mdx`            |
| `src/SearchBar/index.mdx`                                          | Adapt            | Filter Bar or Combobox by search scope                                          | Verified — component: `filter-bar`, `combobox`                 |
| `src/Segmented/index.mdx`                                          | Compose          | Tabs or Button Group with single-selection semantics                            | Verified — composition: `components/tabs.mdx`, `components/button-group.mdx` |
...
| `src/SliderWithInput/index.mdx`                                    | Compose          | Slider with Input Group                                                         | Verified — composition: `components/slider.mdx`, `components/input-group.mdx` |
...
| `src/Video/index.mdx`                                              | Compose          | Native video inside a bounded content surface                                   | Verified — composition: `components/card.mdx`                   |

## Awesome

| Reference source                             | Decision         | A3S target                                   | Current state                                               |
| -------------------------------------------- | ---------------- | -------------------------------------------- | ----------------------------------------------------------- |
| `src/awesome/AuroraBackground/index.mdx`     | Compose          | Optional page-owned ambient color field      | Verified — composition: `foundations/color.mdx`              |
| `src/awesome/BottomGradientButton/index.mdx` | Compose          | Page-owned treatment around Button           | Verified — composition: `components/button.mdx`, `foundations/color.mdx` |
| `src/awesome/Features/index.mdx`             | Compose          | Semantic feature list using Item             | Verified — composition: `components/item.mdx`                |
| `src/awesome/Giscus/index.mdx`               | Host integration | Host-owned discussion service region         | Verified — integration: `components/markdown-surface.mdx`    |
| `src/awesome/GradientButton/index.mdx`       | Compose          | Page-owned treatment around Button           | Verified — composition: `components/button.mdx`, `foundations/color.mdx` |
| `src/awesome/GridBackground/index.mdx`       | Compose          | Optional subject-specific background         | Verified — composition: `foundations/color.mdx`              |
| `src/awesome/Hero/index.mdx`                 | Compose          | Documentation Home or App Page landmark      | Verified — composition: `components/app-page.mdx`            |
| `src/awesome/Spotlight/index.mdx`            | Host integration | Optional host-owned pointer effect           | Verified — integration: `foundations/motion.mdx`             |
| `src/awesome/SpotlightCard/index.mdx`        | Compose          | Card plus optional page-owned pointer effect | Verified — composition: `components/card.mdx`, `foundations/motion.mdx` |
...
| `src/base-ui/Segmented/index.mdx`     | Compose  | Tabs or single-select Button Group                                              | Verified — composition: `components/tabs.mdx`, `components/button-group.mdx` |
...
| Reference source                   | Decision         | A3S target                                                  | Current state                                                                        |
| ---------------------------------- | ---------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| `src/brand/BrandLoading/index.mdx` | Brand substitute | A3S Brand Lockup with bounded loading status                | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LobeChat/index.mdx`     | Brand substitute | A3S Brand Lockup using official OS logo                     | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LobeChatText/index.mdx` | Brand substitute | A3S Brand Lockup text treatment                             | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LobeHub/index.mdx`      | Brand substitute | A3S Brand Lockup using official OS logo                     | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LobeHubText/index.mdx`  | Brand substitute | A3S Brand Lockup text treatment                             | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/Logo3d/index.mdx`       | Brand substitute | Official A3S OS logo; no fabricated 3D mark                 | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LogoFlat/index.mdx`     | Brand substitute | Official A3S OS logo flat presentation                      | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LogoMono/index.mdx`     | Brand substitute | Official A3S OS logo monochrome presentation                | Verified — brand: `components/brand-lockup.mdx` |
| `src/brand/LogoThree/index.mdx`    | Brand substitute | Official A3S OS logo; animation remains optional host media | Verified — brand: `components/brand-lockup.mdx` |
...
| `src/chat/EditableMessage/index.mdx`     | Compose  | Editable Text inside a transcript turn    | Verified — composition: `components/editable-text.mdx`, `components/agent-transcript.mdx` |
| `src/chat/EditableMessageList/index.mdx` | Compose  | Agent Transcript with editable turn state | Verified — composition: `components/agent-transcript.mdx`, `components/editable-text.mdx` |
| `src/chat/LoadingDots/index.mdx`         | Compose  | Message Status or Spinner                 | Verified — composition: `components/message-status.mdx`, `components/spinner.mdx` |
| `src/chat/MessageInput/index.mdx`        | Adapt    | Agent Composer or Textarea by scope       | Verified — component: `agent-composer`, `textarea`         |
| `src/chat/MessageModal/index.mdx`        | Compose  | Dialog with Editable Text                 | Verified — composition: `components/dialog.mdx`, `components/editable-text.mdx` |
| `src/chat/TokenTag/index.mdx`            | Compose  | Status Badge plus Progress                | Verified — composition: `components/status-badge.mdx`, `components/progress.mdx` |
...
| Reference source                     | Decision         | A3S target                                   | Current state                                            |
| ------------------------------------ | ---------------- | -------------------------------------------- | -------------------------------------------------------- |
| `src/icons/Auth0/index.mdx`          | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Authelia/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Authentik/index.mdx`      | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Casdoor/index.mdx`        | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Clerk/index.mdx`          | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Cloudflare/index.mdx`     | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/DingTalk/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Discord/index.mdx`        | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Github/index.mdx`         | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/GoogleChat/index.mdx`     | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/IMessage/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Lark/index.mdx`           | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Line/index.mdx`           | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Logto/index.mdx`          | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/MicrosoftEntra/index.mdx` | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/MicrosoftTeams/index.mdx` | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/NextAuth/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/QQ/index.mdx`             | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Slack/index.mdx`          | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Telegram/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/WeChat/index.mdx`         | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/WhatsApp/index.mdx`       | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/Zitadel/index.mdx`        | Host integration | Icon or Brand Lockup provider slot           | Verified — integration: `components/icon.mdx` |
| `src/icons/lucideExtra/index.mdx`    | Host integration | Icon contract with host-provided outline set | Verified — integration: `components/icon.mdx` |
...
| `src/mdx/Cards/index.mdx`         | Compose          | Card and Resource Card documentation composition | Verified — composition: `components/card.mdx`, `components/resource-card.mdx` |
...
| `src/mdx/mdxComponents/index.mdx` | Host integration | Explicit Markdown renderer registry              | Verified — integration: `components/markdown-surface.mdx`   |
...
| `src/mobile/SafeArea/index.mdx`      | Foundation | Safe-area spacing utilities and Composer policy | Verified — foundation: `foundations/spacing.mdx`, `components/agent-composer.mdx` |
