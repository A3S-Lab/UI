...
- [x] Added the 83-component machine manifest, semantic DOM runtime, optional React and Vue adapters, isolated package checks, and deterministic per-component A3S Test coverage.
- [x] Added owned-part/action/state selector helpers, all-component framework export and type checks, real client mounting, and preview/code switching for every bilingual component example.
