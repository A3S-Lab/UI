...
const codeNodes = [
  ...
  },
  {
    id: "workspace",
    label: "Workspace",
    path: "src/features/code/pages/workspace-page.tsx",
    kind: "component",
    tone: "component",
    size: 10,
    x: -24,
  ...
  },
  {
    id: "task-composer",
    label: "TaskComposer",
    path: "src/features/tasks/components/task-composer.tsx",
    kind: "component",
    tone: "component",
    size: 12,
    x: 46,
  ...
  {
    id: "prompt-editor",
    label: "TaskPromptEditor",
    path: "src/features/tasks/components/task-prompt-editor.tsx",
    kind: "component",
    tone: "component",
    size: 8,
    x: 72,
  ...
  {
    id: "suggestions",
    label: "composer-suggestions.ts",
    path: "src/features/tasks/components/composer-suggestion-ranking.ts",
    kind: "module",
    tone: "module",
    size: 6,
    x: 58,
  ...
  {
    id: "resources",
    label: "session-resource-order.ts",
    path: "src/features/tasks/session-resource-order.ts",
    kind: "module",
    tone: "module",
    size: 7,
    x: 18,
  ...
  {
    id: "tool-calls",
    label: "ToolCallTimeline",
    path: "src/features/tasks/components/tool-call-timeline.tsx",
    kind: "component",
    tone: "component",
    size: 8,
    x: -38,
  ...
  {
    id: "runtime",
    label: "task-runtime-projection.ts",
    path: "src/features/tasks/components/task-runtime-projection.ts",
    kind: "module",
    tone: "module",
    size: 6,
    x: -92,
  ...
  {
    id: "composer-test",
    label: "task-prompt-editor.test.tsx",
    path: "src/features/tasks/components/task-prompt-editor.test.tsx",
    kind: "test",
    tone: "test",
    size: 7,
    x: 48,
  ...
  {
    id: "tool-test",
    label: "tool-call-file-diff.test.tsx",
    path: "src/features/tasks/components/tool-call-file-diff.test.tsx",
    kind: "test",
    tone: "test",
    size: 5,
    x: 78,
    ...
    >
      <header>
        ...
        <div data-code-graph-actions>
          <button
            aria-label={zh ? "缩小图谱" : "Zoom out"}
            className="btn"
            data-code-graph-action="zoom-out"
            data-size="icon-sm"
            data-variant="ghost"
            type="button"
          >
          ...
          <button
            aria-label={zh ? "放大图谱" : "Zoom in"}
            className="btn"
            data-code-graph-action="zoom-in"
            data-size="icon-sm"
            data-variant="ghost"
            type="button"
          >
            ...
            >
              <circle cx="11" cy="11" r="7" />
              <path d="M8 11h6m-3-3v6M20 20l-4-4" />
            </svg>
          </button>
          <button
            aria-label={zh ? "重置视角" : "Reset view"}
            className="btn"
            data-code-graph-action="reset"
            data-size="icon-sm"
            data-variant="ghost"
            type="button"
          >
      ...
      <div data-code-graph-toolbar>
        ...
        <div
          aria-label={zh ? "图谱视图" : "Graph view"}
          className="button-group"
        >
          <button
            aria-pressed="true"
            className="btn"
            data-code-graph-action="view-graph"
            data-code-graph-view="graph"
            data-size="sm"
            type="button"
          >
            3D
          ...
          <button
            aria-pressed="false"
            className="btn"
            data-code-graph-action="view-list"
            data-code-graph-view="list"
            data-size="sm"
      ...
      <div data-code-graph-surface>
        ...
        >
          ...
          <div data-code-graph-empty hidden>
            ...
            <button
              className="btn"
              data-code-graph-action="clear-filter"
              data-size="sm"
              type="button"
            >
        ...
        >
          ...
          <button
            className="btn"
            data-code-graph-action="clear-selection"
            data-size="sm"
            data-variant="outline"
            type="button"
          >
      ...
      <footer>
        ...
        <span>
          {zh
            ? "拖动旋转 · 滚轮缩放 · 方向键可操作"
            : "Drag to rotate · Wheel to zoom · Arrow keys supported"}
        </span>
      </footer>
    </section>
  );
