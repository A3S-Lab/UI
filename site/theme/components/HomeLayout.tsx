...
const componentFamilies: ComponentFamily[] = [
  ...
  },
  {
    ...
    count: "17",
    description: {
      zh: "Designer、Renderer、复杂字段，以及 React 与 Vue 状态接口。",
      en: "Designer, Renderer, complex fields, and React and Vue state surfaces.",
    },
...
const homeCopy = {
  zh: {
    ...
    applicationPatterns: "Form 与 Harness",
    ...
    ctaTitle: "从一个真实界面开始。",
    ctaBody:
      "安装 @a3s-lab/ui，选择视觉基础，然后从 App Shell、Form、Harness 或任一组件契约复制可运行标记。",
    installation: "查看安装方式",
    explore: "浏览组件契约",
    workspace: "工作区 / 最近使用",
    continue: "继续上次工作",
  ...
  en: {
    ...
    applicationPatterns: "Form and Harness",
    ...
    ctaBody:
      "Install @a3s-lab/ui, choose a visual foundation, then copy working markup from App Shell, Form, Harness, or any component contract.",
