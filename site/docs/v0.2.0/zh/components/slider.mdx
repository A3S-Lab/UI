...
<Preview class="w-full max-w-sm">
<input type="range" class="input w-full" aria-label="音量" min="0" max="100" defaultValue="50" />
</Preview>
...
<Preview class="w-full max-w-sm">
<input type="range" class="input w-full" aria-label="音量" min="0" max="100" defaultValue="50" disabled />
</Preview>

### RTL

<Preview class="w-full max-w-sm">
<input type="range" class="input w-full" aria-label="مستوى الصوت" min="0" max="100" defaultValue="50" dir="rtl" />
</Preview>
