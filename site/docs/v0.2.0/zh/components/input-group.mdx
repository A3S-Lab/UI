...
<div class="grid gap-6">
  ...
  <div class="input-group">
    <input type="email" aria-label="电子邮箱" placeholder="Enter your email" />
  ...
  <div class="input-group">
    <input type="text" aria-label="卡号" placeholder="Card number" />
...
<div class="grid gap-6">
  ...
  <div class="input-group">
    <input type="text" aria-label="用户名" placeholder="Enter your username" />
    <span data-align="end">@company.com</span>
  </div>
  <div class="input-group" data-orientation="vertical">
    <textarea aria-label="消息" placeholder="Enter your message"></textarea>
    <footer data-align="end">
...
<div class="grid gap-6">
  <div class="input-group">
    <input type="text" aria-label="个人资料链接" readonly placeholder="https://x.com/shadcn" />
  ...
  <div class="input-group">
    <input type="text" aria-label="搜索" placeholder="Type to search..." />
...
<div class="grid gap-6">
  <div class="input-group">
    <input type="text" aria-label="文件名" placeholder="Enter file name" />
  ...
  <div class="input-group [--radius:1rem]">
    <input type="text" aria-label="搜索查询" placeholder="Enter search query" />
...
<div class="grid gap-6">
  <div class="input-group">
    <input type="text" aria-label="搜索状态" placeholder="Searching..." />
  ...
  <div class="input-group">
    <input type="text" aria-label="处理状态" placeholder="Processing..." />
    <span data-align="start"><svg aria-label="Loading" role="status" class="animate-spin lucide lucide-loader-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg></span>
  </div>
  <div class="input-group">
    <input type="text" aria-label="保存状态" placeholder="Saving changes..." />
    <span data-align="end">
      Saving...
  ...
  <div class="input-group">
    <input type="text" aria-label="刷新状态" placeholder="Refreshing data..." />
...
<Preview class="w-full max-w-sm">
<div class="input-group" data-orientation="vertical">
  <textarea data-control aria-label="消息" placeholder="Autoresize textarea..." class="field-sizing-content min-h-16 resize-none"></textarea>
  <footer data-align="end">
