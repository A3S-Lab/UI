...
export function Example() {
  ...
  return (
    <Dialog ref={control.ref} aria-label="Dialog"><div><header><h2>组件摘要</h2></header><section>组件内容</section><footer><button type="button">继续</button></footer></div></Dialog>
  );
}
```
...
<template>
  <Dialog ref="componentRef" aria-label="Dialog"><div><header><h2>组件摘要</h2></header><section>组件内容</section><footer><button type="button">继续</button></footer></div></Dialog>
</template>
```
