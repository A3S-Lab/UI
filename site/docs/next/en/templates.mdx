...
<Callout title="The standalone template CLI is retired" icon="triangle-alert">
Template files now ship with `@a3s-lab/ui`. Install the package and copy the files from `node_modules/@a3s-lab/ui/templates`.
</Callout>

A3S UI ships optional Nunjucks and Jinja macros for components with larger HTML structures. They generate the same semantic A3S UI markup shown in the component docs, while keeping repeated server-rendered markup easier to maintain.

The templates are versioned with `@a3s-lab/ui`, so the generated markup matches the CSS and JavaScript files you installed.

## Macros

| Component | Macro | Nunjucks | Jinja |
| --- | --- | --- | --- |
| [Combobox](/components/combobox) | `combobox()` | [combobox.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/combobox.njk) | [combobox.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/combobox.html.jinja) |
| [Command](/components/command) | `command()` | [command.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/command.njk) | [command.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/command.html.jinja) |
| [Command](/components/command) | `command_dialog()` | [command.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/command.njk) | [command.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/command.html.jinja) |
| [Context Menu](/components/context-menu) | `context_menu()` | [context-menu.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/context-menu.njk) | [context-menu.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/context-menu.html.jinja) |
...
| [Dropdown Menu](/components/dropdown-menu) | `dropdown_menu()` | [dropdown-menu.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/dropdown-menu.njk) | [dropdown-menu.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/dropdown-menu.html.jinja) |
| [Popover](/components/popover) | `popover()` | [popover.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/popover.njk) | [popover.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/popover.html.jinja) |
| [Select](/components/select) | `select()` | [select.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/select.njk) | [select.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/select.html.jinja) |
| [Sidebar](/components/sidebar) | `sidebar()` | [sidebar.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/sidebar.njk) | [sidebar.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/sidebar.html.jinja) |
| [Tabs](/components/tabs) | `tabs()` | [tabs.njk](https://github.com/A3S-Lab/UI/blob/main/src/templates/nunjucks/tabs.njk) | [tabs.html.jinja](https://github.com/A3S-Lab/UI/blob/main/src/templates/jinja/tabs.html.jinja) |
...
<Steps>
  <Step>
    ...
    Copy the template folder for your template engine from `@a3s-lab/ui`. Templates are meant to be app-owned, so you can edit them after copying.
    ...
    You can also copy the [Nunjucks templates](https://github.com/A3S-Lab/UI/tree/main/src/templates/nunjucks) or [Jinja templates](https://github.com/A3S-Lab/UI/tree/main/src/templates/jinja) from GitHub.
  </Step>
  <Step>
    ### Use a Macro
...
| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `trigger` | `string` | required | HTML for the pointer or keyboard invocation surface. |
| `label` | `string` | `"Context menu"` | Accessible menu name. |
| `id` | `string` | generated | Unique Context Menu id. |
| `main_attrs` | `object` | `{}` | Extra attributes for the `.context-menu` root. |
| `trigger_attrs` | `object` | `{}` | Extra attributes for the invocation surface. |
...
| `label` | `string` | `None` / `none` | Stable accessible name for a standalone trigger. Omit when a connected external label names the trigger. |
