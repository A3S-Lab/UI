...
Button Group organizes related actions into one visual and keyboard-navigation unit for adjacent, segmented, or menu-backed controls.
...
<div role="group" aria-label="Search" class="button-group">
  <input type="text" class="input" placeholder="Search..." aria-label="Search messages" />
...
<div role="group" class="button-group">
  ...
  <div role="group" class="button-group">
    <div class="input-group">
      <input type="text" placeholder="Send a message..." aria-label="Message" />
...
<div class="flex items-stretch gap-2">
  <div role="group" aria-label="Currency amount" class="button-group">
    ...
    <input type="text" class="input" placeholder="10.00" aria-label="Amount" />
  </div>
...
export function Example() {
  return (
    <ButtonGroup role="group" aria-label="Message actions">
