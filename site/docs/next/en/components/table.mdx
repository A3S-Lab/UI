...
export function Example() {
  ...
  return (
    <Table ref={control.ref}><table><caption>Component summary</caption><tbody><tr><th scope="row">Name</th><td>Component content</td></tr></tbody></table></Table>
  );
}
```
...
<template>
  <Table ref="componentRef"><table><caption>Component summary</caption><tbody><tr><th scope="row">Name</th><td>Component content</td></tr></tbody></table></Table>
</template>
```
