...
<div class="a3s-sidebar-demo">
  ...
  <main>
    <div>
      ...
      <button type="button" class="btn" data-variant="outline" onclick="document.getElementById('demo-sidebar').toggle()">Toggle sidebar</button>
    </div>
  </main>
</div>
</Preview>
...
export function Example() {
  ...
  return (
    <Sidebar ref={control.ref} aria-label="Sidebar">Component content</Sidebar>
  );
}
```
...
<template>
  <Sidebar ref="componentRef" aria-label="Sidebar">Component content</Sidebar>
</template>
```
