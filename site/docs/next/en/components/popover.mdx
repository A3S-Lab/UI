  ...
  <div id="demo-popover-popover" data-popover aria-hidden="true" class="w-72">
    ...
    <form class="grid gap-2" onsubmit="event.preventDefault()">
      <div class="grid grid-cols-3 items-center gap-4">
        ...
        <input type="text" id="demo-popover-width" defaultValue="100%" class="input col-span-2 h-8" autoFocus />
      </div>
      <div class="grid grid-cols-3 items-center gap-4">
        <label for="demo-popover-max-width">Max. width</label>
        <input type="text" id="demo-popover-max-width" defaultValue="300px" class="input col-span-2 h-8" />
      </div>
      <div class="grid grid-cols-3 items-center gap-4">
        <label for="demo-popover-height">Height</label>
        <input type="text" id="demo-popover-height" defaultValue="25px" class="input col-span-2 h-8" />
      </div>
      <div class="grid grid-cols-3 items-center gap-4">
        <label for="demo-popover-max-height">Max. height</label>
        <input type="text" id="demo-popover-max-height" defaultValue="none" class="input col-span-2 h-8" />
      </div>
    </form>
  </div>
</div>
