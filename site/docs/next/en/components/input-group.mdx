...
Input Group combines a text input with prefixes, suffixes, icons, or tightly related actions inside one input boundary.
...
<dl>
  ...
  <dd>
    The root shell. Add <code>role="group"</code> and an accessible label only
    when the group itself needs to be named.
    <dl>
      <dt>
      ...
      <dd>
        The native control. Use <code>aria-invalid="true"</code> for invalid
        state and <code>disabled</code> for disabled state.
      </dd>
      <dt>
      ...
      <dd>
        Decorative or helper content. Use <code>aria-hidden="true"</code> for
        decorative icons.
      </dd>
      <dt>
      ...
      <dd>
        Interactive actions. Use <code>role="group"</code> with an accessible
        label when multiple related actions share one side of the input.
      </dd>
      <dt>
      ...
      <dd>
        Optional visual placement. Values use logical direction, so start/end
        automatically flip in RTL. Use <code>data-orientation="vertical"</code>{" "}
        on the root for header/footer layouts.
      </dd>
      <dt>
        <code>[data-control]</code>
      </dt>
      <dd>
        Escape hatch for custom controls that are not native <code>input</code>,{" "}
...
<Preview class="w-full max-w-sm">
  <div
    role="group"
    aria-label="Block start input group examples"
    class="fieldset"
  >
    <div class="field">
...
<Preview class="w-full max-w-sm">
  <div
    role="group"
    aria-label="Block end input group examples"
    class="fieldset"
  >
    <div class="field">
...
<Preview class="w-full max-w-sm">
  <div class="grid gap-6">
    ...
    <div class="input-group">
      <input type="text" aria-label="Card number" placeholder="Card number" />
      <span data-align="start" aria-hidden="true">
        <svg
...
<Preview class="w-full max-w-sm">
  <div class="grid gap-6">
    <div class="input-group">
      <input type="text" aria-label="Amount" placeholder="0.00" />
      <span data-align="start">$</span>
      <span data-align="end">USD</span>
    </div>
    <div class="input-group">
      <input type="text" aria-label="Domain name" placeholder="example.com" />
...
<Preview class="w-full max-w-sm">
  <div class="grid gap-6">
    ...
    <div class="input-group [--radius:9999px]">
      ...
      <input type="text" id="input-secure-19" aria-label="Secure URL" />
      <button
        type="button"
        class="btn"
        data-variant="ghost"
...
<Preview class="w-full max-w-sm">
  <div class="grid gap-6">
    <div class="input-group">
      <input type="text" aria-label="File name" placeholder="Enter file name" />
