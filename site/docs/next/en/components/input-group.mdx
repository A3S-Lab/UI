...
<div class="grid gap-6">
  ...
  <div class="input-group" data-orientation="vertical">
    <textarea aria-label="Message" placeholder="Enter your message"></textarea>
    <footer data-align="end">
...
<div class="grid gap-6">
  <div class="input-group">
    <input type="text" aria-label="Profile URL" readonly placeholder="https://x.com/shadcn" />
...
<div class="grid gap-6">
  ...
  <div class="input-group [--radius:1rem]">
    <input type="text" aria-label="Search query" placeholder="Enter search query" />
...
<div class="grid gap-6">
  <div class="input-group">
    <input type="text" aria-label="Search status" placeholder="Searching..." />
  ...
  <div class="input-group">
    <input type="text" aria-label="Processing status" placeholder="Processing..." />
    <span data-align="start"><svg aria-label="Loading" role="status" class="animate-spin lucide lucide-loader-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg></span>
  </div>
  <div class="input-group">
    <input type="text" aria-label="Save status" placeholder="Saving changes..." />
    <span data-align="end">
      Saving...
  ...
  <div class="input-group">
    <input type="text" aria-label="Refresh status" placeholder="Refreshing data..." />
...
<div class="input-group min-h-[200px]" data-orientation="vertical">
  <textarea aria-label="Code editor" placeholder="console.log('Hello, world!');"></textarea>
...
<Preview class="w-full max-w-sm">
<div class="input-group" data-orientation="vertical">
  <textarea data-control aria-label="Message" placeholder="Autoresize textarea..." class="field-sizing-content min-h-16 resize-none"></textarea>
  <footer data-align="end">
