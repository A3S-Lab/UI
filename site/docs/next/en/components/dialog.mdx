...
export function Example() {
  ...
  return (
    <Dialog ref={control.ref} aria-label="Dialog"><div><header><h2>Component summary</h2></header><section>Component content</section><footer><button type="button">Continue</button></footer></div></Dialog>
  );
}
```
...
<template>
  <Dialog ref="componentRef" aria-label="Dialog"><div><header><h2>Component summary</h2></header><section>Component content</section><footer><button type="button">Continue</button></footer></div></Dialog>
</template>
```
