...
<Callout title="basecoat-cli is deprecated" icon="triangle-alert">
Template files now ship with `@a3s-lab/ui`. If you previously copied templates with `basecoat-cli`, install `@a3s-lab/ui` instead and copy the files from `node_modules/@a3s-lab/ui/templates`.
</Callout>
