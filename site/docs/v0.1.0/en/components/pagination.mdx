...
<Callout title="No dedicated component" icon="circle-alert">
  There is no dedicated pagination component in A3S UI.
</Callout>
  ...
  return (
    ...
    >
      <ul className="flex flex-row items-center gap-1">
        <li>
          <a href="#" className="btn" data-variant="ghost">
            <svg
        ...
        <li>
          <a href="#" className="btn" data-variant="ghost" data-size="icon">
            1
          </a>
        </li>
        <li>
          <a href="#" className="btn" data-variant="outline" data-size="icon">
            2
          </a>
        </li>
        <li>
        ...
        <li>
          <div className="size-9 flex items-center justify-center">
            <svg
              className="size-4 shrink-0 lucide lucide-ellipsis"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
    ...
    <ul class="flex flex-row items-center gap-1">
      ...
      <li>
        <div class="size-9 flex items-center justify-center">
          <svg
            class="size-4 shrink-0 lucide lucide-ellipsis"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
