...
<div class="flex w-full flex-col gap-6" data-item-primary-demo="zh">
  <p class="text-sm text-muted-foreground" data-item-status aria-live="polite">尚未执行操作</p>
  <article class="item" data-variant="outline" data-item-kind="basic">
    ...
    <aside>
      <button type="button" class="btn" data-variant="outline" data-size="sm" data-item-action="basic" data-preview-onclick onclick="this.closest('[data-item-primary-demo]').querySelector('[data-item-status]').textContent = '已触发操作'">操作</button>
    </aside>
  </article>
