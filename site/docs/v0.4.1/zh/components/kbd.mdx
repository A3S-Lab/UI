...
<Preview>
<div class="flex flex-col items-center gap-4" data-kbd-primary-demo="zh">
  <span class="inline-flex items-center gap-1" data-kbd-chord="modifiers">
    <kbd class="kbd" data-kbd-key="meta">⌘</kbd>
    <kbd class="kbd" data-kbd-key="shift">⇧</kbd>
    <kbd class="kbd" data-kbd-key="alt">⌥</kbd>
    <kbd class="kbd" data-kbd-key="ctrl">⌃</kbd>
  </span>
  <span class="inline-flex items-center gap-1" data-kbd-chord="toggle-sidebar">
    <kbd class="kbd" data-kbd-key="ctrl-label">Ctrl</kbd>
    <span>+</span>
    <kbd class="kbd" data-kbd-key="b">B</kbd>
  </span>
  <p class="text-sm text-muted-foreground" data-kbd-hint>切换侧边栏</p>
</div>
</Preview>
