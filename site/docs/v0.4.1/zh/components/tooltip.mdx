...
工具提示在悬停或聚焦时补充简短说明，不能承载完成任务所必需的信息或操作。

<Preview>
<div data-tooltip-primary-demo="zh">
<button type="button" class="btn" data-variant="outline" data-tooltip-trigger data-tooltip="添加到资源库">悬停</button>
</div>
</Preview>
...
```tsx
import { Tooltip } from "@a3s-lab/ui/react";
...
import { Tooltip } from "@a3s-lab/ui/vue";
</script>
