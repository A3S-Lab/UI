...
下拉菜单把与触发器相关的一组离散操作收纳在临时浮层中，适合低频次级命令。

<Preview>
<div data-dropdown-primary-demo="zh" id="demo-dropdown-menu" class="dropdown-menu">
  <button type="button" id="demo-dropdown-menu-trigger" data-dropdown-trigger aria-haspopup="menu" aria-controls="demo-dropdown-menu-menu" aria-expanded="false" class="btn" data-variant="outline">打开账户菜单</button>
  <div id="demo-dropdown-menu-popover" data-popover aria-hidden="true" class="w-40">
    <div role="menu" id="demo-dropdown-menu-menu" aria-labelledby="demo-dropdown-menu-trigger">
      <div role="group" aria-labelledby="demo-dropdown-account">
        <div role="heading" id="demo-dropdown-account">我的账户</div>
        <div role="menuitem" data-dropdown-item="profile">
          <span>个人资料</span>
          <kbd>⇧⌘P</kbd>
        </div>
        <div role="menuitem" data-dropdown-item="billing">
          <span>账单</span>
          <kbd>⌘B</kbd>
        </div>
        <div role="menuitem" data-dropdown-item="settings">
          <span>设置</span>
          <kbd>⌘S</kbd>
        </div>
      </div>
      <hr role="separator" />
      <div role="group">
        <div role="menuitem" data-dropdown-item="team">团队</div>
        <div role="menuitem" data-dropdown-item="new-team">
          <span>新建团队</span>
          <kbd>⌘+T</kbd>
        </div>
      </div>
      <hr role="separator" />
      <div role="group">
        <div role="menuitem" data-dropdown-item="github">GitHub</div>
        <div role="menuitem" data-dropdown-item="support">帮助与支持</div>
        <div role="menuitem" data-dropdown-item="api" aria-disabled="true">API</div>
      </div>
      <hr role="separator" />
      <div role="group">
        <div role="menuitem" data-dropdown-item="logout">
          <span>退出登录</span>
          <kbd>⇧⌘Q</kbd>
        </div>
      </div>
...
<Callout title="支持模板宏" icon="code" action={{ label: "查看模板", href: "/templates#dropdown_menu" }}>
该组件为 Jinja 和 Nunjucks 提供了 `dropdown_menu()` 宏。
</Callout>
...
使用CDN或批量程序导入？请参见[安装页](/installation)。
  ...
  <Step title="添加下拉菜单 HTML">

```html
<div id="demo-dropdown-menu" class="dropdown-menu">
  <button type="button" id="demo-dropdown-menu-trigger" aria-haspopup="menu" aria-controls="demo-dropdown-menu-menu" aria-expanded="false" class="btn" data-variant="outline">打开账户菜单</button>
  <div id="demo-dropdown-menu-popover" data-popover aria-hidden="true" class="w-40">
    <div role="menu" id="demo-dropdown-menu-menu" aria-labelledby="demo-dropdown-menu-trigger">
      <div role="group" aria-labelledby="demo-dropdown-account">
        <div role="heading" id="demo-dropdown-account">我的账户</div>
...
<dl>
  ...
  <dd>
    ...
    <dl>
      ...
      <dd>触发按钮。脚本负责切换 <code>aria-expanded</code> 并管理键盘导航。</dd>
      <dt><code>&lt;div data-popover aria-hidden="true"&gt;</code></dt>
      <dd>
        菜单浮层。使用 <code>data-side="top|right|bottom|left|inline-start|inline-end"</code> 和 <code>data-align="start|center|end"</code> 控制位置。共享运行时会在可视视口内自动翻转、约束并重新定位浮层。
        <dl>
          <dt><code>&lt;div role="menu"&gt;</code></dt>
          <dd>
            菜单项、分组、标题和分隔线的容器。
            <dl>
              <dt><code>&lt;div role="group" aria-labelledby="&#123; HEADING_ID &#125;"&gt;</code> <span class="badge" data-variant="secondary">可选</span></dt>
              <dd>对相关菜单项进行分组。</dd>
              <dt><code>&lt;div role="heading" id="&#123; HEADING_ID &#125;"&gt;</code> <span class="badge" data-variant="secondary">可选</span></dt>
              <dd>分组标题或标签。</dd>
              <dt><code>&lt;div role="menuitem"&gt;</code></dt>
              <dd>标准操作项。禁用时使用 <code>aria-disabled="true"</code>。</dd>
              <dt><code>&lt;div role="menuitemcheckbox" aria-checked="true"&gt;</code></dt>
              <dd>复选菜单项。使用带 <code>data-indicator</code> 的子元素显示选中图标。</dd>
              <dt><code>&lt;div role="menuitemradio" aria-checked="true"&gt;</code></dt>
              <dd>单选菜单项。使用带 <code>data-indicator</code> 的子元素显示选中图标。</dd>
              <dt><code>&lt;kbd&gt;</code> <span class="badge" data-variant="secondary">可选</span></dt>
              <dd>与菜单项行尾对齐的快捷键提示。</dd>
...
| 应用程序编程接口 | 类型 | 描述 |
| --- | --- | --- |
| `dropdown.open()` | 方法 | 打开菜单。 |
| `dropdown.close()` | 方法 | 关闭菜单。 |
| `dropdown.toggle()` | 方法 | 切换菜单。 |
| `dropdown.refresh()` | 方法 | 在现有 `role="menu"` 元素内的子项发生更改后重新扫描菜单项。 |

React 的 `useDropdownMenu` 与 Vue 的同名 composable 通过 `call()` 暴露这四个方法。
...
<div id="dropdown-basic" class="dropdown-menu">
  <button type="button" id="dropdown-basic-trigger" aria-haspopup="menu" aria-controls="dropdown-basic-menu" aria-expanded="false" class="btn" data-variant="outline">打开菜单</button>
  <div id="dropdown-basic-popover" data-popover aria-hidden="true" class="min-w-32">
    <div role="menu" id="dropdown-basic-menu" aria-labelledby="dropdown-basic-trigger">
      <div role="group" aria-labelledby="dropdown-basic-account">
        <div role="heading" id="dropdown-basic-account">我的账户</div>
        <div role="menuitem">个人资料</div>
        <div role="menuitem">账单</div>
...
<div id="dropdown-shortcuts" class="dropdown-menu">
  <button type="button" id="dropdown-shortcuts-trigger" aria-haspopup="menu" aria-controls="dropdown-shortcuts-menu" aria-expanded="false" class="btn" data-variant="outline">打开菜单</button>
  <div id="dropdown-shortcuts-popover" data-popover aria-hidden="true" class="min-w-46">
    <div role="menu" id="dropdown-shortcuts-menu" aria-labelledby="dropdown-shortcuts-trigger">
      <div role="group" aria-labelledby="dropdown-shortcuts-account">
        <div role="heading" id="dropdown-shortcuts-account">我的账户</div>
        <div role="menuitem">
          <span>个人资料</span>
          <kbd>⇧⌘P</kbd>
        </div>
...
<div id="dropdown-icons" class="dropdown-menu">
  <button type="button" id="dropdown-icons-trigger" aria-haspopup="menu" aria-controls="dropdown-icons-menu" aria-expanded="false" class="btn" data-variant="outline">打开菜单</button>
...
<div id="dropdown-checkboxes" class="dropdown-menu">
  <button type="button" id="dropdown-checkboxes-trigger" aria-haspopup="menu" aria-controls="dropdown-checkboxes-menu" aria-expanded="false" class="btn" data-variant="outline">选择界面区域</button>
  <div id="dropdown-checkboxes-popover" data-popover aria-hidden="true" class="w-40">
    <div role="menu" id="dropdown-checkboxes-menu" aria-labelledby="dropdown-checkboxes-trigger">
      <div role="group" aria-labelledby="dropdown-checkboxes-label">
        <div role="heading" id="dropdown-checkboxes-label">界面区域</div>
...
<div id="dropdown-checkboxes-icons" class="dropdown-menu">
  <button type="button" id="dropdown-checkboxes-icons-trigger" aria-haspopup="menu" aria-controls="dropdown-checkboxes-icons-menu" aria-expanded="false" class="btn" data-variant="outline">通知设置</button>
  <div id="dropdown-checkboxes-icons-popover" data-popover aria-hidden="true" class="w-48">
    <div role="menu" id="dropdown-checkboxes-icons-menu" aria-labelledby="dropdown-checkboxes-icons-trigger">
      <div role="group" aria-labelledby="dropdown-checkboxes-icons-label">
        <div role="heading" id="dropdown-checkboxes-icons-label">通知偏好</div>
        <div role="menuitemcheckbox" aria-checked="true">
          <span data-indicator><svg class="lucide lucide-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span>
...
<div id="dropdown-radio-group" class="dropdown-menu">
  <button type="button" id="dropdown-radio-group-trigger" aria-haspopup="menu" aria-controls="dropdown-radio-group-menu" aria-expanded="false" class="btn" data-variant="outline">选择面板位置</button>
  <div id="dropdown-radio-group-popover" data-popover aria-hidden="true" class="min-w-32">
    <div role="menu" id="dropdown-radio-group-menu" aria-labelledby="dropdown-radio-group-trigger">
      <div role="group" aria-labelledby="dropdown-radio-label">
        <div role="heading" id="dropdown-radio-label">面板位置</div>
...
<div id="dropdown-radio-icons" class="dropdown-menu">
  <button type="button" id="dropdown-radio-icons-trigger" aria-haspopup="menu" aria-controls="dropdown-radio-icons-menu" aria-expanded="false" class="btn" data-variant="outline">付款方式</button>
  <div id="dropdown-radio-icons-popover" data-popover aria-hidden="true" class="min-w-56">
    <div role="menu" id="dropdown-radio-icons-menu" aria-labelledby="dropdown-radio-icons-trigger">
      <div role="group" aria-labelledby="dropdown-radio-icons-label">
        <div role="heading" id="dropdown-radio-icons-label">选择付款方式</div>
        <div role="menuitemradio" aria-checked="true">
          <span data-indicator><svg class="lucide lucide-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span>
...
<div id="dropdown-destructive" class="dropdown-menu">
  <button type="button" id="dropdown-destructive-trigger" aria-haspopup="menu" aria-controls="dropdown-destructive-menu" aria-expanded="false" class="btn" data-variant="outline">更多操作</button>
...
<div id="dropdown-avatar" class="dropdown-menu">
  <button type="button" id="dropdown-avatar-trigger" aria-haspopup="menu" aria-controls="dropdown-avatar-menu" aria-expanded="false" class="btn rounded-full" data-variant="ghost" data-size="icon">
    <span class="avatar">
      <A3SAssetImage path="/assets/images/avatar-1.png" alt="shadcn" />
      <span>LR</span>
    </span>
  </button>
...
```tsx
import { DropdownMenu, useDropdownMenu } from "@a3s-lab/ui/react";

export function Example() {
  const control = useDropdownMenu();
  return (
    <DropdownMenu ref={control.ref}>
      <button
        type="button"
        id="project-actions-trigger"
        className="btn"
      ...
      <div data-popover aria-hidden="true" className="min-w-36">
        <div
          id="project-actions-menu"
          role="menu"
          aria-labelledby="project-actions-trigger"
        >
          <div role="menuitem">重命名</div>
          <div role="menuitem">创建副本</div>
          <hr role="separator" />
          <div role="menuitem" data-variant="destructive">删除项目</div>
        </div>
      </div>
    </DropdownMenu>
  );
...
`useDropdownMenu` 订阅清单中声明的 DOM 事件，并且只调用清单中公开的方法。适配器不创建另一套框架专属状态。

## Vue

```vue
<script setup>
import { DropdownMenu, useDropdownMenu } from "@a3s-lab/ui/vue";
...
<template>
  <DropdownMenu ref="componentRef">
    ...
    <div data-popover aria-hidden="true" class="min-w-36">
      <div
        id="project-actions-menu"
        role="menu"
        aria-labelledby="project-actions-trigger"
