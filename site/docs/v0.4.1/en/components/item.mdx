...
Item presents one scannable record through a stable arrangement of title, description, metadata, and actions.

<Preview class="w-full max-w-md">
<div class="flex w-full flex-col gap-6" data-item-primary-demo="en">
  <p class="text-sm text-muted-foreground" data-item-status aria-live="polite">No action yet</p>
  <article class="item" data-variant="outline" data-item-kind="basic">
    <section>
      <h3>Basic Item</h3>
      <p>A simple item with title and description.</p>
    </section>
    <aside>
      <button type="button" class="btn" data-variant="outline" data-size="sm" data-item-action="basic" data-preview-onclick onclick="this.closest('[data-item-primary-demo]').querySelector('[data-item-status]').textContent = 'Basic action pressed'">Action</button>
    </aside>
  </article>
  <a href="#item-verified" class="item" data-variant="outline" data-size="sm" data-item-kind="link">
  ...
  <button type="button" class="item" data-variant="outline" data-size="sm" data-item-kind="button">
    <span data-item-content><strong>run_01JY7K</strong><small>Exact Agent release</small></span>
    <span data-item-actions><span class="status-badge" data-state="active" data-indicator>Running</span></span>
  </button>
</div>
</Preview>
## Usage
...
Use inline content markers when the whole item is a native button; sectioning elements are not valid button children.

```html
<button type="button" class="item" data-variant="outline">
  <span data-item-content><strong>run_01JY7K</strong><small>Exact Agent release</small></span>
  <span data-item-actions><span class="status-badge" data-state="active">Running</span></span>
</button>
```
...
<dl>
  <dt><code>&lt;article class="item"&gt;</code>, <code>&lt;a class="item"&gt;</code>, or <code>&lt;button class="item"&gt;</code></dt>
  <dd>
    ...
    <dl>
      ...
      <dt><code>[data-item-content]</code>, <code>[data-item-actions]</code> <span class="badge" data-variant="secondary">Button items</span></dt>
      <dd>Inline content and trailing metadata for a native button root.</dd>
