...
Badge labels a status, category, or count with short text so users can scan quickly without mistaking it for a primary action.

<Preview>
<div class="flex flex-wrap gap-2" data-badge-primary-demo="en">
  <span class="badge" data-badge-item="default">Badge</span>
  <span class="badge" data-variant="secondary" data-badge-item="secondary">Secondary</span>
  <span class="badge" data-variant="destructive" data-badge-item="destructive">Destructive</span>
  <span class="badge" data-variant="outline" data-badge-item="outline">Outline</span>
</div>
</Preview>
...
<div class="flex flex-wrap gap-2">
  ...
  <span class="badge bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-300">Amber</span>
...
<template><Badge>Default</Badge></template>
```
