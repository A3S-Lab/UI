...
<section class="accordion" data-accordion-primary-demo="en">
  <details open data-accordion-item="shipping">
    <summary>
  ...
  <details data-accordion-item="returns">
    <summary>
...
`useAccordion` subscribes to manifest-declared DOM events and calls only public manifest methods. The adapter creates no second, framework-only state model.
