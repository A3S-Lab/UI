...
<div class="grid gap-3" data-pagination-primary-demo="en">
  <p class="text-sm text-muted-foreground" data-pagination-status aria-live="polite">Page 2</p>
  <nav class="pagination" aria-label="Pagination">
    <ul>
      <li>
        <button type="button" class="btn" data-variant="ghost" data-pagination-direction="previous" aria-label="Previous page">
      ...
      <li><button type="button" class="btn" data-variant="ghost" data-size="icon" data-pagination-page="1" aria-label="Page 1">1</button></li>
      <li><button type="button" class="btn" data-variant="outline" data-size="icon" data-pagination-page="2" aria-label="Page 2" aria-current="page">2</button></li>
      <li><button type="button" class="btn" data-variant="ghost" data-size="icon" data-pagination-page="3" aria-label="Page 3">3</button></li>
      ...
      <li>
        <button type="button" class="btn" data-variant="ghost" data-pagination-direction="next" aria-label="Next page">
