...
Kbd displays shortcuts or key sequences in a platform-familiar form and should describe only keyboard actions the product actually supports.

<Preview>
<div class="flex flex-col items-center gap-4" data-kbd-primary-demo="en">
