...
Theme Switcher lets users choose light, dark, or system appearance and applies that preference immediately across the interface.
...
<button
  ...
  data-side="bottom"
  data-a3s-theme-toggle
  data-theme-switcher-primary-demo="en"
  data-preview-onclick
  onclick="window.a3sUI.theme.toggle()"
  class="btn theme-switcher size-8" data-variant="outline" data-size="icon"
>
...
```html
<button type="button" aria-label="Toggle dark mode" data-tooltip="Toggle dark mode" data-side="bottom" data-a3s-theme-toggle onclick="window.a3sUI.theme.toggle()" class="btn theme-switcher size-8" data-variant="outline" data-size="icon">
  <span class="hidden dark:block"><svg class="lucide lucide-sun" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4" /><path d="M12 2v2" /><path d="M12 20v2" /><path d="m4.93 4.93 1.41 1.41" /><path d="m17.66 17.66 1.41 1.41" /><path d="M2 12h2" /><path d="M20 12h2" /><path d="m6.34 17.66-1.41 1.41" /><path d="m19.07 4.93-1.41 1.41" /></svg></span>
  <span class="block dark:hidden"><svg class="lucide lucide-moon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401" /></svg></span>
</button>
```
...
| --- | --- | --- |
| `window.a3sUI.theme.get()` | Method | Returns `"dark"` or `"light"`. |
| `window.a3sUI.theme.set(mode)` | Method | Sets the mode to `"dark"` or `"light"` and stores it in `localStorage.themeMode`. |
| `window.a3sUI.theme.toggle()` | Method | Toggles between dark and light mode. |

## React

```tsx
import { ThemeSwitcher, useThemeSwitcher } from "@a3s-lab/ui/react";

export function Example() {
  const control = useThemeSwitcher();
  return (
    <ThemeSwitcher
      ref={control.ref}
      aria-label="Toggle dark mode"
...
`useThemeSwitcher` subscribes to manifest-declared DOM events and calls only public manifest methods. The adapter creates no second, framework-only state model.

## Vue

```vue
<script setup lang="ts">
import { ThemeSwitcher, useThemeSwitcher } from "@a3s-lab/ui/vue";
