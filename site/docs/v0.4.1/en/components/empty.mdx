...
Empty state explains why content is absent and, when a next step is available, offers one clear recovery action.

<Preview>
<section class="empty" data-empty-primary-demo="en">
  <header>
  ...
  <footer>
    <div class="flex gap-2">
      <button type="button" class="btn" data-empty-action="create" data-preview-onclick onclick="this.closest('[data-empty-primary-demo]').dataset.emptyStatus='create'">Create Project</button>
      <button type="button" class="btn" data-variant="outline" data-empty-action="import">Import Project</button>
    </div>
    <a href="#empty-learn-more" class="btn text-muted-foreground" data-variant="link" data-size="sm" data-empty-action="learn">
      Learn More
  ...
  <p class="sr-only" data-empty-status aria-live="polite"></p>
</section>
</Preview>
...
<section class="empty">
  <header>
    <figure class="size-12 rounded-full">
      <A3SAssetImage class="grayscale" alt="@shadcn" path="/assets/images/avatar-1.png" />
    </figure>
    <h3>User Offline</h3>
...
<section class="empty">
  <header>
    <figure class="-space-x-2 [&_img]:ring-background [&_img]:ring-2 [&_img]:grayscale [&_img]:size-12 [&_img]:rounded-full">
      <A3SAssetImage alt="@shadcn" path="/assets/images/avatar-1.png" />
      <A3SAssetImage alt="@maxleiter" path="/assets/images/avatar-3.png" />
      <A3SAssetImage alt="@evilrabbit" path="/assets/images/avatar-2.png" />
    </figure>
...
<section class="empty">
  ...
  <footer>
    <div class="input-group sm:w-3/4">
      <input type="search" aria-label="Search pages" placeholder="Try searching for pages..." />
...
```tsx
import { Empty } from "@a3s-lab/ui/react";
...
import { Empty } from "@a3s-lab/ui/vue";
</script>
...
<template>
  <Empty>
    ...
    <footer>
      ...
      <a
        href="#"
        class="btn text-muted-foreground"
        data-variant="link"
        data-size="sm"
      >
        Learn More
