...
<Callout title="Presentation utility" icon="info">
...
<article class="item bg-muted/50 border-transparent" data-spinner-primary-demo="en" aria-busy="true">
  <figure><svg aria-label="Loading" role="status" class="animate-spin lucide lucide-loader-circle" data-spinner-status xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg></figure>
  <section> <h3 data-spinner-title>Processing payment...</h3></section>
...
The complete A3S UI stylesheet stops the rotation when the user requests reduced motion. Keep the accessible label and nearby status copy so progress remains understandable while the glyph is static.
...
<div class="flex w-full max-w-md flex-col gap-4">
  <div class="input-group">
    <input aria-label="Message" placeholder="Send a message..." disabled />
  ...
  <div class="input-group">
    <textarea aria-label="Message" placeholder="Send a message..." disabled></textarea>
