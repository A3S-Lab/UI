...
<div class="grid w-full justify-items-start gap-4" data-alert-dialog-primary-demo="en">
  <button type="button" data-alert-dialog-trigger onclick="const dialog = document.getElementById('demo-alert-dialog'); if (dialog.open) dialog.close(); dialog.style.cssText = ''; dialog.firstElementChild.style.cssText = ''; dialog.showModal()" class="btn" data-variant="outline">Open confirmation dialog</button>
  ...
  <div style="position:relative;inset:auto;translate:none;scale:1;transform:none;max-height:none;margin:0">
    ...
    <footer>
      <button type="button" class="btn" data-variant="outline" data-alert-dialog-cancel onclick="this.closest('dialog').close()">Cancel</button>
      <button type="button" class="btn" data-variant="destructive" data-alert-dialog-confirm onclick="this.closest('dialog').close()">Delete account</button>
    </footer>
  </div>
  </dialog>
</div>
  ...
  return (
    ...
    >
      <div>
        <header>
          <h2 id="demo-alert-dialog-title">Are you absolutely sure?</h2>
          <p id="demo-alert-dialog-description">
        ...
        <footer>
          ...
          <button className="btn" data-variant="destructive">
            Continue
          </button>
        </footer>
      </div>
  ...
  >
    <div>
      ...
      <footer>
        ...
        <button class="btn" data-variant="destructive">Continue</button>
      </footer>
    </div>
  </AlertDialog>
</template>
