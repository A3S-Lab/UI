...
Dropdown Menu contains a set of discrete actions related to its trigger in a temporary surface suited to infrequent secondary commands.

<Preview>
<div data-dropdown-primary-demo="en" id="demo-dropdown-menu" class="dropdown-menu">
  <button type="button" id="demo-dropdown-menu-trigger" data-dropdown-trigger aria-haspopup="menu" aria-controls="demo-dropdown-menu-menu" aria-expanded="false" class="btn" data-variant="outline">Open</button>
  <div id="demo-dropdown-menu-popover" data-popover aria-hidden="true" class="w-40">
    <div role="menu" id="demo-dropdown-menu-menu" aria-labelledby="demo-dropdown-menu-trigger">
      ...
      <hr role="separator" />
      <div role="group">
        <div role="menuitem" data-dropdown-item="team">Team</div>
      ...
      <div role="group">
        ...
        <div role="menuitem" data-dropdown-item="support">Support</div>
...
<dl>
  ...
  <dd>
    ...
    <dl>
      ...
      <dd>
        Menu content popover. Set <code>data-side="top|right|bottom|left|inline-start|inline-end"</code> and <code>data-align="start|center|end"</code> to control placement. The shared runtime flips, clamps, and repositions the surface within the visual viewport.
        <dl>
...
React `useDropdownMenu` and the equivalent Vue composable expose all four methods through `call()`.
    ...
    <DropdownMenu ref={control.ref}>
      ...
      <div data-popover aria-hidden="true" className="min-w-36">
        ...
        >
          ...
          <hr role="separator" />
          <div role="menuitem" data-variant="destructive">Delete project</div>
        </div>
      </div>
    </DropdownMenu>
  );
...
`useDropdownMenu` subscribes to manifest-declared DOM events and calls only public manifest methods. The adapter creates no second, framework-only state model.
