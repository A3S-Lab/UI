...
Avatar identifies a person or entity with an image, initials, or fallback in compact lists, messages, and collaborative surfaces.

<Preview>
<div class="flex flex-row flex-wrap items-center gap-12" data-avatar-primary-demo="en">
  <span class="avatar" data-avatar-item="shadcn">
    <A3SAssetImage path="/assets/images/avatar-1.png" alt="@shadcn" />
    <span>CN</span>
  </span>
  <span class="avatar rounded-lg" data-avatar-item="evilrabbit">
    <A3SAssetImage path="/assets/images/avatar-2.png" alt="@evilrabbit" />
    <span>ER</span>
  </span>
  <div class="avatar-group [&_.avatar]:grayscale" data-avatar-group>
    <span class="avatar">
      <A3SAssetImage path="/assets/images/avatar-1.png" alt="@shadcn" />
      <span>CN</span>
    </span>
    <span class="avatar">
      <A3SAssetImage path="/assets/images/avatar-3.png" alt="@maxleiter" />
      <span>LR</span>
    </span>
    <span class="avatar">
      <A3SAssetImage path="/assets/images/avatar-2.png" alt="@evilrabbit" />
...
<Preview>
<span class="avatar">
  <A3SAssetImage path="/assets/images/avatar-3.png" alt="@pranathip" />
  <span>PP</span>
...
<div class="avatar-group">
  <span class="avatar"><A3SAssetImage path="/assets/images/avatar-1.png" alt="@shadcn" /><span>CN</span></span>
  <span class="avatar"><A3SAssetImage path="/assets/images/avatar-3.png" alt="@maxleiter" /><span>LR</span></span>
  <span class="avatar"><A3SAssetImage path="/assets/images/avatar-2.png" alt="@evilrabbit" /><span>ER</span></span>
</div>
</Preview>
