...
<Preview>
<div class="flex items-center gap-4" data-skeleton-primary-demo="en" aria-busy="true" aria-label="Loading profile">
  <div class="skeleton size-10 shrink-0 rounded-full" data-skeleton-part="avatar"></div>
  <div class="grid gap-2">
    <div class="skeleton h-4 w-[250px]" data-skeleton-part="title"></div>
    <div class="skeleton h-4 w-[200px]" data-skeleton-part="subtitle"></div>
  </div>
</div>
</Preview>
...
<template><Skeleton class="h-4 w-[150px]" /></template>
```
