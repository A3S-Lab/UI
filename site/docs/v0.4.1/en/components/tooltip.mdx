...
Tooltip adds a short explanation on hover or focus and must not contain information or actions required to complete a task.

<Preview>
<div data-tooltip-primary-demo="en">
<button type="button" class="btn" data-variant="outline" data-tooltip-trigger data-tooltip="Add to library">Hover</button>
</div>
</Preview>
