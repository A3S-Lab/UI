...
<Preview>
<nav class="breadcrumb" aria-label="Breadcrumb" data-breadcrumb-primary-demo="en">
  <ol>
    <li><a href="#breadcrumb-home" data-breadcrumb-link="home">Home</a></li>
    ...
    <li><a href="#breadcrumb-components" data-breadcrumb-link="components">Components</a></li>
    <li aria-hidden="true"><svg data-rtl-flip class="lucide lucide-chevron-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6" /></svg></li>
    <li><span aria-current="page" data-breadcrumb-current>Breadcrumb</span></li>
  </ol>
</nav>
</Preview>
...
export function Example() {
  return (
    <Breadcrumb aria-label="Breadcrumb"><a href="#current" aria-current="page">Current page</a></Breadcrumb>
  );
}
```
