...
<Preview>
  ...
  >
    ...
    <footer class="status-bar w-full" data-status-bar-primary-demo="en" aria-label="Document status">
    <div data-status-info>
      <span data-status-priority="low">Page 1 of 12</span>
      <span data-status-priority="low">132 words</span>
      <span class="text-[var(--a3s-green)]" data-status-saved>Saved</span>
    </div>
...
export function Example() {
  return (
    <StatusBar as="footer" aria-label="Document status">
      <div data-status-info="">
        <span data-status-priority="low">Page 1 of 12</span>
        <span>Saved</span>
      </div>
      <div data-status-actions="">
        <button type="button">Open sync details</button>
      </div>
    </StatusBar>
  );
}
...
<template>
  <StatusBar as="footer" aria-label="Document status">
    <div data-status-info="">
      <span data-status-priority="low">Page 1 of 12</span><span>Saved</span>
    </div>
    <div data-status-actions="">
      <button type="button">Open sync details</button>
    </div>
