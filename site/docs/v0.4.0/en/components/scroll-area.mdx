...
<div class="card h-72 p-0">
  <div class="scrollbar h-full overflow-y-auto p-4" tabindex="0">
    <div class="space-y-4">
...
The component class augments native scrolling for cross-browser styling. It does not wrap content, replace browser scroll behavior, or require JavaScript. Hosts that need keyboard scrolling should keep the overflow element focusable (`tabindex="0"` or a native control).
