...
The system now exposes 116 public component contracts. Eighty-six general components cover controls, navigation, content, overlays, and product structure, while the 30-component Harness groups task, conversation, execution, review, evidence, file navigation, knowledge management, editing, terminal, log, and device-preview workflows for Coding Agents.
...
The integrated [Form system](https://a3s-lab.github.io/UI/components/form-system/) adds a deterministic Form Core, visual Designer, controlled Renderer, durable interaction contracts, a Cloud host adapter, CLI, Web Components, React Hook Form integration, and native Vue composables. Its guides and interactive examples live directly in the A3S UI component catalog.
...
| `@a3s-lab/ui/manifest`              | Machine-readable metadata for all 116 public components                                                                      |
...
| `@a3s-lab/ui/form/a3s-ui.css`       | A3S UI plus Form layout and interaction styles for product surfaces                                                          |
...
The release contract currently maps 116 public components, 94 Playground exports, and 20 Harness or Playground surfaces to 230 substantive PRDs. The checked ACL inventory and evidence totals live in `product-requirements/README.md`. `npm run test:e2e:a3s:check` rejects missing, duplicate, shallow, stale, or invalid mappings before a browser run; the machine-readable indexes live under `product-requirements/`.
