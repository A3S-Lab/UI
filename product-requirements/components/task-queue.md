...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=task-queue]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `idle`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=idle]:has([data-a3s-components~='task-queue'][data-a3s-state~='idle'])`
  - `running`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=running]:has([data-a3s-components~='task-queue'][data-a3s-state~='running'][aria-busy=true])`
  - `paused`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=paused]:has([data-a3s-components~='task-queue'][data-a3s-state~='paused'])`
  - `blocked`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=blocked]:has([data-a3s-components~='task-queue'][data-a3s-state~='blocked'])`
  - `complete`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=complete]:has([data-a3s-components~='task-queue'][data-a3s-state~='complete'])`
  - `error`: `.a3s-component-state-matrix[data-open][data-component=task-queue] [data-state-specimen=error]:has([data-a3s-components~='task-queue'][data-a3s-state~='error'])`
