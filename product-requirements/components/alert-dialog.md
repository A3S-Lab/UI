...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=alert-dialog]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `open`: `.a3s-component-state-matrix[data-open][data-component=alert-dialog] [data-state-specimen=open]:has([data-a3s-components~='alert-dialog'][data-a3s-state~='open']:is([open],[aria-expanded=true]))`
  - `closed`: `.a3s-component-state-matrix[data-open][data-component=alert-dialog] [data-state-specimen=closed]:has([data-a3s-components~='alert-dialog'][data-a3s-state~='closed']:is(:not([open]),[aria-expanded=false]))`
