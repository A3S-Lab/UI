...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=code-editor]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=code-editor] [data-state-specimen=ready]:has([data-a3s-components~='code-editor'][data-a3s-state~='ready'][data-dirty=false])`
  - `dirty`: `.a3s-component-state-matrix[data-open][data-component=code-editor] [data-state-specimen=dirty]:has([data-a3s-components~='code-editor'][data-a3s-state~='dirty'][data-dirty=true])`
  - `invalid`: `.a3s-component-state-matrix[data-open][data-component=code-editor] [data-state-specimen=invalid] [data-a3s-components~='code-editor'][data-a3s-state~='invalid'][data-validation-state=invalid]:has(textarea[aria-invalid=true])`
  - `readonly`: `.a3s-component-state-matrix[data-open][data-component=code-editor] [data-state-specimen=readonly] [data-a3s-components~='code-editor'][data-a3s-state~='readonly'][data-readonly]:has(textarea[readonly])`
