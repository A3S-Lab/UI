# Radio Group Product Requirements
...
| Priority | P0 |
| Category | `forms` |
| Public route | `/en/components/radio-group.html` |
| Stable selector | `[data-a3s-components~="radio-group"]` |
| Interaction scenario | `components-actions-forms.acl#radio-group` |
| Evidence scenario | `tests/e2e/component-contracts.acl#component-contract-radio-group` |
...
Add one canonical `.radio-group` root while retaining role/data aliases. Own one required single-choice set with legend and native radio behavior.
...
- Required root attributes: `role=radiogroup`.
...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=radio-group]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Behavioral regression: `components-actions-forms.acl`, scenario `radio-group`.
- Cross-framework, keyboard, responsive, theme, direction, and visual contract: `tests/e2e/component-contracts.acl`, scenario `component-contract-radio-group`.
- Route under test: `http://127.0.0.1:4178/UI/en/components/radio-group.html`.
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=radio-group] [data-state-specimen=ready] [data-a3s-components~='radio-group'][data-a3s-state~='ready']:has(input[type=radio][value=comfortable]:checked)`
  - `disabled`: `.a3s-component-state-matrix[data-open][data-component=radio-group] [data-state-specimen=disabled] [data-a3s-components~='radio-group'][data-a3s-state~='disabled'][aria-disabled=true]:has(input[type=radio][value=comfortable]:checked:disabled)`
  - `invalid`: `.a3s-component-state-matrix[data-open][data-component=radio-group] [data-state-specimen=invalid] [data-a3s-components~='radio-group'][data-a3s-state~='invalid'][aria-invalid=true][data-validation-state=invalid]:has(input[type=radio][required][aria-invalid=true]:invalid):has([data-state-specimen-feedback][role=alert])`
