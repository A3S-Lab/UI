...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=checkpoint]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `saving`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=saving]:has([data-a3s-components~='checkpoint'][data-a3s-state~='saving'][aria-busy=true])`
  - `saved`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=saved]:has([data-a3s-components~='checkpoint'][data-a3s-state~='saved'])`
  - `restoring`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=restoring]:has([data-a3s-components~='checkpoint'][data-a3s-state~='restoring'][aria-busy=true])`
  - `restored`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=restored]:has([data-a3s-components~='checkpoint'][data-a3s-state~='restored'])`
  - `expired`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=expired]:has([data-a3s-components~='checkpoint'][data-a3s-state~='expired'])`
  - `error`: `.a3s-component-state-matrix[data-open][data-component=checkpoint] [data-state-specimen=error]:has([data-a3s-components~='checkpoint'][data-a3s-state~='error'])`
