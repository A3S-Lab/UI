...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=icon]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=icon] [data-state-specimen=ready]:has([data-a3s-components~='icon'][data-a3s-state~='ready'])`
  - `decorative`: `.a3s-component-state-matrix[data-open][data-component=icon] [data-state-specimen=decorative]:has([data-a3s-components~='icon'][data-a3s-state~='decorative'])`
  - `labeled`: `.a3s-component-state-matrix[data-open][data-component=icon] [data-state-specimen=labeled]:has([data-a3s-components~='icon'][data-a3s-state~='labeled'])`
  - `host-provided`: `.a3s-component-state-matrix[data-open][data-component=icon] [data-state-specimen=host-provided]:has([data-a3s-components~='icon'][data-a3s-state~='host-provided'])`
