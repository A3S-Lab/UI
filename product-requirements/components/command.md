...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=command]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=command] [data-state-specimen=ready]:has([data-a3s-components~='command'][data-a3s-state~='ready'])`
  - `empty`: `.a3s-component-state-matrix[data-open][data-component=command] [data-state-specimen=empty]:has([data-a3s-components~='command'][data-a3s-state~='empty'])`
  - `loading`: `.a3s-component-state-matrix[data-open][data-component=command] [data-state-specimen=loading]:has([data-a3s-components~='command'][data-a3s-state~='loading'][aria-busy=true])`
  - `open`: `.a3s-component-state-matrix[data-open][data-component=command] [data-state-specimen=open]:has([data-a3s-components~='command'][data-a3s-state~='open']:is([open],[aria-expanded=true]))`
  - `closed`: `.a3s-component-state-matrix[data-open][data-component=command] [data-state-specimen=closed]:has([data-a3s-components~='command'][data-a3s-state~='closed']:is(:not([open]),[aria-expanded=false]))`
