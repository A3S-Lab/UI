...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=skeleton]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `loading`: `.a3s-component-state-matrix[data-open][data-component=skeleton] [data-state-specimen=loading]:has([data-a3s-components~='skeleton'][data-a3s-state~='loading'][aria-busy=true])`
