...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=badge]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=badge] [data-state-specimen=ready]:has([data-a3s-components~='badge'][data-a3s-state~='ready'])`
  - `secondary`: `.a3s-component-state-matrix[data-open][data-component=badge] [data-state-specimen=secondary]:has([data-a3s-components~='badge'][data-a3s-state~='secondary'])`
  - `outline`: `.a3s-component-state-matrix[data-open][data-component=badge] [data-state-specimen=outline]:has([data-a3s-components~='badge'][data-a3s-state~='outline'])`
  - `destructive`: `.a3s-component-state-matrix[data-open][data-component=badge] [data-state-specimen=destructive]:has([data-a3s-components~='badge'][data-a3s-state~='destructive'])`
