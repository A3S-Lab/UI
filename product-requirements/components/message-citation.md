...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=message-citation]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=message-citation] [data-state-specimen=ready]:has([data-a3s-components~='message-citation'][data-a3s-state~='ready'])`
  - `visited`: `.a3s-component-state-matrix[data-open][data-component=message-citation] [data-state-specimen=visited]:has([data-a3s-components~='message-citation'][data-a3s-state~='visited'][aria-current])`
  - `unavailable`: `.a3s-component-state-matrix[data-open][data-component=message-citation] [data-state-specimen=unavailable]:has([data-a3s-components~='message-citation'][data-a3s-state~='unavailable']:is([disabled],[aria-disabled=true],:has([disabled]),:has([aria-disabled=true])))`
  - `error`: `.a3s-component-state-matrix[data-open][data-component=message-citation] [data-state-specimen=error]:has([data-a3s-components~='message-citation'][data-a3s-state~='error'])`
