...
- The state acceptance matrix opens at `.a3s-component-state-matrix[data-open][data-component=stepper]`, preserves hidden roots in the DOM contract, and keeps product dismiss/focus restore for interactive users (contract runs reload after matrix evidence because CDP cannot dismiss the overlay).
...
- Per-state evidence selectors:
  - `ready`: `.a3s-component-state-matrix[data-open][data-component=stepper] [data-state-specimen=ready]:has([data-a3s-components~='stepper'][data-a3s-state~='ready'])`
  - `active`: `.a3s-component-state-matrix[data-open][data-component=stepper] [data-state-specimen=active]:has([data-a3s-components~='stepper'][data-a3s-state~='active'][data-active=true])`
  - `success`: `.a3s-component-state-matrix[data-open][data-component=stepper] [data-state-specimen=success]:has([data-a3s-components~='stepper'][data-a3s-state~='success'])`
  - `warning`: `.a3s-component-state-matrix[data-open][data-component=stepper] [data-state-specimen=warning]:has([data-a3s-components~='stepper'][data-a3s-state~='warning'])`
  - `danger`: `.a3s-component-state-matrix[data-open][data-component=stepper] [data-state-specimen=danger]:has([data-a3s-components~='stepper'][data-a3s-state~='danger'])`
