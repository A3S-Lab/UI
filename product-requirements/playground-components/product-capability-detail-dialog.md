...
The component is exercised at `dialog.product-capability-detail-dialog[open]` by `tests/e2e/product-capability-navigation.acl#capability-first-navigation-desktop`. That scenario owns the state-changing path; the route scenario independently owns direct-load, responsive, accessibility, console, page-error, and screenshot evidence.
...
- The real interaction path `capability-first-navigation-desktop` explicitly targets `dialog.product-capability-detail-dialog[open]` and proves a state-changing keyboard or pointer action in the same component-owned workflow.
...
- Behavior evidence: `tests/e2e/product-capability-navigation.acl#capability-first-navigation-desktop`, with stable target `dialog.product-capability-detail-dialog[open]`.
