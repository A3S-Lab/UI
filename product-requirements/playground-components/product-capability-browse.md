...
- The real interaction path `capability-first-navigation-desktop` explicitly targets `[data-product-surface=catalog] [data-directory-layout]` and proves a state-changing keyboard or pointer action in the same component-owned workflow.
...
- Behavior evidence: `tests/e2e/product-capability-navigation.acl#capability-first-navigation-desktop`, with stable target `[data-product-surface=catalog] [data-directory-layout]`.
